...
public class ApplicationController {
    ...
    public Application insert(@Valid @RequestBody Application application) {
        return applicationService.save(application);

    }

    @RequestMapping(value = "/{id}", method = RequestMethod.PUT)
    public ResponseEntity<Application> update(@PathVariable("id") Long id, @Valid @RequestBody Application application) {
        try {
