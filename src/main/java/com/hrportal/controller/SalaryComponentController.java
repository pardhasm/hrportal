...
public class SalaryComponentController {
    ...
    public SalaryComponent insert(@Valid @RequestBody SalaryComponent salaryComponent) {
        return salaryComponentService.save(salaryComponent);

    }

    @RequestMapping(value = "/{id}", method = RequestMethod.PUT)
    public ResponseEntity<SalaryComponent> update(@PathVariable("id") Long id, @Valid @RequestBody SalaryComponent salaryComponent) {
        try {
